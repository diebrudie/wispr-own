...
/// CoreAudio input-device enumeration. Devices are stored by UID (stable
/// across reboots/replugs) and resolved to a live AudioDeviceID at use time.
enum AudioDevices {
    static let defaultsKey = "micUID" // empty/absent = system default
