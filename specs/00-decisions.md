...
| 2026-07-08 | #8 | v0.3: main hub window (specs 09/10) modeled on Wispr Flow screenshots — Home (stats + searchable history), Dictionary (manual terms biasing Whisper via initial_prompt), Settings as sheet overlay (hotkey, mic picker, dictation-language multi-select). Violet theme from the app icon. Confirmed out of scope: Insights page, UI localization (EN-only), dictionary auto-learning. |
